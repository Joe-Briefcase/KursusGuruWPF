...
public class SeleniumLogin : ISelenium
{
    ...
    private string dtuInside = "https://www.inside.dtu.dk/";
    private string dtuLearn = "https://learn.inside.dtu.dk/";
    ...
    //En generel metode til at logge ind på DTU's hjemmesider.
     private void login(String username, String password, IWebDriver _driver)
    {
